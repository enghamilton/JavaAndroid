...
import com.example.speechtotextclientside.R;
import com.example.speechtotextclientside.WriteToFileExample;
   ...
   switch (requestCode) {
		 case SPEECH_RECOGNITION_CODE: 
			 if (resultCode == RESULT_OK && data != null) {	
				 ...
				 myString.append(System.getProperty("line.separator")+text);
