...
import com.example.speechtotextserverside.SecondActivity;
...
public class MainActivity extends Activity {
 ...
 private AsyncTask asyncTaskSpeech;
  ...
  */
  ...
  btnSend.setOnClickListener(new OnClickListener(){
   ...
   public void onClick(View v) {
	   asyncTaskSpeech = new speechToTextAsyncTask().execute();
	   /*
 ...
 public class speechToTextAsyncTask extends AsyncTask<String,Integer,Void>{
		...
		protected Void doInBackground(String... arg0) {
			...
			for(Map.Entry<String, Integer> entry : map.entrySet()) {
			    ...
			    //audioPlay.putExtra(INTENT_PLAY_AUDIO, value.toString());
			    //audioPlay.putExtra(INTENT_PLAY_AUDIO, "900000001");
			    ...
			    try {
			    	...
			    	player.setDataSource(afd.getFileDescriptor(),afd.getStartOffset(),afd.getLength());
			 	 	...
			 	 	//player.setDataSource(Environment.getExternalStorageDirectory().getPath()+"/recordedCalls/20170728"+value.toString()+".mp3");
			 	 	player.prepare();
			 		player.start();
			     	try {
							Thread.sleep(15000);
